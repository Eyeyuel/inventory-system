...
import { CreateProductDto, FindProductsDto } from '@inventory-system/dto';
...
export class ProductController {
  ...
  findAll(@Payload() payload: { filters: FindProductsDto; userId: string }) {
    return this.productService.findAll(payload.filters, payload.userId);
  }
