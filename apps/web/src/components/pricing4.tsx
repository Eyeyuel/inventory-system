...
const Pricing4 = ({
  ...
  plans = [
    ...
    },
    {
      ...
      monthlyPrice: '$29',
      yearlyPrice: '$249',
      features: ['Everything in FREE', 'Live call support every month', 'Unlimited Storage'],
      buttonText: 'Purchase',
    },
    {
      name: 'Elite',
      ...
      monthlyPrice: '$59',
      yearlyPrice: '$549',
      features: ['Everything in PRO', 'Advanced analytics', 'Custom branding', 'Unlimited users'],
      buttonText: 'Purchase',
      isPopular: true,
    },
  ],
